...
public class ObjectManipulatorMediumScale : MonoBehaviour
{
    ...
    private Vector3 minScale = new Vector3(0.1957104f, 0.1957104f, 0.1957104f); // Minimum scale
    private Vector3 maxScale = new Vector3(0.370421f, 0.370421f, 0.370421f);    // Maximum scale
