...
public class ObjectManipulator : MonoBehaviour
{
    ...
    private float zoomSpeed = 0.001f; // Slightly faster scaling speed

    private Vector3 minScale = new Vector3(0.001288797f, 0.001288797f, 0.001288797f); // Updated minimum scale
    private Vector3 maxScale = new Vector3(0.003232437f, 0.003232437f, 0.003232437f); // Updated maximum scale
